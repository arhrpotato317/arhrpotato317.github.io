...
- 사용자의 선택에 해당하는 정보를 불러오기 위해 필요한 URL에 들어갈 추가적으로 구해야 하는 데이터가 있다.
  - 경기 라운드

#### 1-2. 경기 날짜
- 배구연맹 사이트의 [GAME > V-리그 -> 일정 및 경기결과]페이지의 방송편성 중 경기년도/월 정보를 크롤링하여 첫화면에서 사용자가 선택할 수 있도록 화면에 보내준다.
```py
...
#### 개발 도움닫기(TIL)
- 현재 날짜 구하기 [ 참고 : https://yujuwon.tistory.com/entry/%ED%98%84%EC%9E%AC-%EB%82%A0%EC%A7%9C-%EA%B0%80%EC%A0%B8%EC%98%A4%EA%B8%B0 ]
```py
